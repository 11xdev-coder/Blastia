...
public class BlastiaGame : Game
{
    ...
    public BlastiaGame(bool fullscreen)
    {
        ...
        if (!VideoManager.Instance.IsFullScreen && fullscreen) // fullscreen was disabled and we enabled it
        {
            Console.WriteLine("Enabled fullscreen");
            VideoManager.Instance.SetFullscreen(fullscreen);
            VideoManager.Instance.SaveStateToFile<VideoManagerState>(); // resave
        }
    ...
    protected override void LoadContent()
    {
        try
        {
            ...
            AddMenu(new PlayerSelectionMenu(MainFont));
            AddMenu(new WorldSelectionMenu(MainFont));
